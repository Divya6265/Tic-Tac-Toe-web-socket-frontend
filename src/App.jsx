...
function App() {
  ...
  return (
    ...
    <div className='bg-[#4b495f] text-white w-full h-screen '>
      ...
      {
        playOnline && (opponent !== null) && opponentLeft && <div className='flex justify-center items-center h-full'>
          <p className='text-4xl font-semibold'>Opponent left match you won the game!</p>
        </div>
...
//   socket?.on("OpponentFound", (data) => {
//     setOpponentSocketId(data.OpponentSocket)
//     setOpponent(data.OpponentName)
//     setCurrentPlayer(data.currentPlayer)
